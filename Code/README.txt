...
The code allows to open and plot the standardized Matlab files shared on the corresponding Mobilise-d Zenodo repository (https://doi.org/10.5281/zenodo.7185429) by using Python (code in 'Python code for access' folder) and R (code in 'R code for access' folder). 
